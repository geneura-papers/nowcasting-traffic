...
\ead{\{antares, amorag, mgarenas, pablogarcia, gustavo, pacv, jmerelo\}@ugr.es, vrivas@ujaen.es}
...
There are many works related with traffic flow forecasting, each of them approaching the problem with different models. These include: series models, Kalman Filter Theory \cite{ASJC:ASJC1051}, Markov Chain models, non-parametric methods, simulation models, local regression models, fuzzy-neural approaches, sequential learning, spectral analysis, Bayesian networks, neural networks, diffusion models or Big Data based approaches \cite{SurveyKumar2007}.  %(buscar referencias recientes de cada una y ponerlas si queremos ampliar este párrafo)
% Antonio - pos eso. ;D
%
