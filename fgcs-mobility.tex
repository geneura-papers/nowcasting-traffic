...
% Study of people flow with data from the ETSIIT/Discoteque nodes...
...
Because devices can capture data from the university staff and the students two of them has been placed very close of the main access trying to distinguish staff (1) from students (2). The back door (3) is also the parking an can be used only by the staff.
