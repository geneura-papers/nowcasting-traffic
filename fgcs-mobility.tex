...
\begin{itemize}
    ...
    \item An interurban road, where the traffic flows have been studied and contrasted with real traffic data, using statistical methods to estimate the real number of vehicles. Forecast techniques have been applied with very good results in the short-term. The forecast has been applied both real traffic values as captured values with MOBYWIT, balanced with the calculated ratio of devices captured / real vehicles. Moreover, the travel average duration matrix has been calculated for journeys from to each node by week days and time intervals.
