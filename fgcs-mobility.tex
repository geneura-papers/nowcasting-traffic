...
>>>>>>> a31db4a7bc2967ec9011e7f16b3a56ceb42723a1
=======
>>>>>>> 9148774f0fc280afd9b6bd3c5409371860e4aedb

In order to analyze the data, several features have been extracted (generated) from the gathered `events', composing a pattern per device of its whole stay in the disco. These are described in Table \ref{tab:extracted_features_disco}.
