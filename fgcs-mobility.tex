...
These data
% Antonio - quiz� se podr�a quitar esto, ya que se analizar� en el caso del tr�fico en carreteras (datos DGT)
...
% El estado del arte de la predicci�n de trafico, voy a poner la idea en espa�ol en comentarios para estructur�rmela yo misma en la cabeza.
...
% Al tratarse de un tema muy estudiado, existen tambi�n numerosos res�menes que te dan una idea general sobre este �mbito como el [SurveyKumar2007] publicado en el 2007 y centrado en la predicci�n del tr�fico a corto plazo, o el publicado en 2012 por E. Bolshinsky [SurveyBolshinsky2012] donde se repasan las diferentes t�cnicas utilizadas, los datos de entrada que necesita cada una y algunas arquitecturas de los sistemas utilizados. Tambi�n hay res�menes espec�ficos para un tipo de predicci�n como el propio [SurveyKumar2007] o [Vlahogianni2014] que tiene un enfoque un poco m�s generalista clasificando la literatura existente en los objetivos que persegu�a cada trabajo o dentro de qu� ambito estaba emarcado cada art�culo, como por ejemplo si predec�a el tr�fico o predec�a el tiempo esperado para un desplazamiento o estaba centrado en la forma de recolecci�n de los datos utilizados.
...
%Algunos de los trabajos m�s recientes que versan sobre la predicci�n del tr�fico intentan ya integrar nuevas tecnolog�as como "Big Data" [TrafficFlowPredictionWithBigData2015] donde intentan abarcar nuevos enfoques en la predicci�n incluyendo una predicci�n temporal y espacial simult�neamente utilizando modelos de predicci�n simples como piezas que forman un sistema mucho m�s complejo.
...
%Tambi�n existen numerosas revistas que proponen n�meros especiales que versan sobre este tema [Zhang20141], donde se puede encontrar los �ltimos avances que intentan ir m�s all� y predecir no s�lo el estado del tr�fico sino el tiempo de los desplazamientos [Dong201420] [Zou201433]  utilizando modelos espacio-temporales del tr�fico en diferentes situaciones (spatial?temporal patterns of the congested and non-congested traffic) o trabajos que le dan una vuelta de tuerca m�s a las t�cnicas y proponen nuevos m�todos de predicci�n [Zhang201465] utilizando datos del tr�fico en tiempo real o m�todos ya conocidos y mejorados como [Wang201479][Qi201495].
...
\begin{figure}[ht]
	\begin{center}
		...
		% Antonio - explicar lo que se ve en las gr�ficas (histograma y serie). Lo de la serie quiz� no sea necesario
		\label{fig:disco_data}
	\end{center}
\end{figure}
% Antonio - Antares porfa, genera las gr�ficas correctas. ;)
...
% Antonio - si no se aplica clasificaci�n corregir esto.
...
% Antonio - No recuerdo si en esta �cpoca pod�an entrar/salir estudiantes todav�a... �Antares de qu� cu�ndo son los datos?
...
%\label{tab:nodosDGT}
%\end{table}
% Antonio - Fergu, no s� si no ser� mejor poner el mapa con los nodos en lugar de sus posiciones en la tabla. Es m�s comprensible su situaci�n. ;)
% FERGU: Hecho
%DATOS A MOSTRAR:
