...
In addition, and as it is shown in Figure \ref{fig:mobywit}, the device runs an specific Operative System, called \textit{Horeb}, which is a modification of the original Raspbian 3.10.24, adapted by MOBYWIT system designer to be more robust (to power fails, for instance) and reliable.
...
Six nodes were placed along different roads in Andalusia (south Spain). 
