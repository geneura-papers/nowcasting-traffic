...
After processing and summarising data, a total of 2200 different devices were detected in one of the busy nights in September (from a Thursday at 8 pm to Friday at 8 am), following the distribution per node shown in Figure \ref{fig:disco_data}. 
...
U-MATRIX graph shows three big clusters (blue areas), corresponding the bottom one to very frequent devices (they have returned more than 30 times). This lead us to think in staff going to work. Most of them are related with high stay times in the Terrace (node 102), as it is displayed in the Plane Analysis.
...
The knowledge extracted in this two analyses could be of interest for many issues, apart from the direct testing of the occupation with regard to the disco legal capacity. 
