...
\caption{Error values computed using the differences between DGT real data and the ones forecasted by ETS method, after converting the latest using Median (by Hour) Ratio. Period to be forecasted started on 25-Oct-2015, 00:00 hours and finished on 31-Oct-2105, 23:45 hours, establishing the horizon to 1. Best (=lowest) values are highlighted in bold.}
