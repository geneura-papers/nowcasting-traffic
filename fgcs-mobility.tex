...
Nowadays, the transformation of any city into a Smart City, with better values of energy saving, citizen's free time, access to more resources and less cost, is a process that must be supported by powerful and reliable technologies, methods and systems. 
...
By joining BT and WiFi we pursue to increase the detection rate further than most people has achieved. Apparently it can seem redundant but the detection likelihood is higher with both systems. We need to study more deeply the improvement of the combined detection but on average a 80\% of WiFi devices and a 20\% of BT are detected. BT is specially important for the detection of cars because it is technology include in almost every new car. The same is true for WiFi and smartphones. Another interesting characteristic is that even when people disconnect WiFi their devices keep on sending signals.
