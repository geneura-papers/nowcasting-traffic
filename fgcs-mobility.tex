...
The information Mobywit device is able to provide for urban scope is amazing but we are mainly interesting in two goals: to mesure the trip time among several points in a city and the path the drivers follow across the city to arrive the closer highway. The reason for these goals is because the local council of our city are interesting on them because they  
