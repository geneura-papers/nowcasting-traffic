...
\begin{itemize}
\item Total ratio: El número de vehiculos detectados por la DGT / el numero detectado por nosotros
\item Dividir una serie entre otra
\item Average ratio: se coge el ratio cada 15 minutos de (la dgt/lo nuestro), se suma todos esos ratios, y se divide entre el número de rangos de 15 minutos %TAMBIEN COGER LA MEDIANA
