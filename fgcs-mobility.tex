...
The application of SOM produces the graph shown in Figure \ref{fig:som_disco}.

\begin{figure}[ht]
	\begin{center}
		\includegraphics[width=14cm]{imgs/DISCO/som_disco.eps}
		\caption{Detected devices in a night in the Discotheque scenario.}
		\label{fig:som_disco}
	\end{center}
\end{figure}
% Antonio - Poner la figura de experimento definitivo
