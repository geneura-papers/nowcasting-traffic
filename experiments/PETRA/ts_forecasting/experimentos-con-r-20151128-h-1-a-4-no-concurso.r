...
bbdd<-function( aBD, horizonte ) {
  cat( "\n\n\n" );
  cat( "==========================================================================================\n" );
  cat( " @vrivas      ", aBD, " Horizonte ", horizonte, "\n" );
  cat( "==========================================================================================\n" );
  cat( "\n" );
  miEts( aBD, horizonte );
...
bbdd_NoConcurso<-function( aBD, horizonte ) {
  cat( "\n\n\n" );
  cat( "==========================================================================================\n" );
  cat( " @vrivas   NO CONCURSO   ", aBD, " Horizonte ", horizonte, "\n" );
  cat( "==========================================================================================\n" );
  cat( "\n" );
...
#horizonte <- 1 #myarg;
#cat ( "Horizonte: (1 para el dia siguiente)", horizonte,"\n" );

path="./data_ts_forecasting/";

aBD="PETRA_1011_con_0";
dataTS<-ts( scan ( paste ( path,aBD,".trn", sep="" ) , comment.char="@"  ) )
deseadas<-scan ( paste( path,aBD,".tst", sep="" ) , comment.char="@"  )
bbdd_NoConcurso( aBD, 1 );

#Uso un solo fichero: PETRA_1011_con_0 #aBD="DGT_1021";
dataTS<-ts( scan ( paste ( path,aBD,".trn", sep="" ) , comment.char="@"  ) )
deseadas<-scan ( paste( path,aBD,".tst", sep="" ) , comment.char="@"  )
bbdd_NoConcurso( aBD, 2 );

#aBD="DGT_1031";
dataTS<-ts( scan ( paste ( path,aBD,".trn", sep="" ) , comment.char="@"  ) )
deseadas<-scan ( paste( path,aBD,".tst", sep="" ) , comment.char="@"  )
bbdd_NoConcurso( aBD, 3 );

#aBD="DGT_1051";
dataTS<-ts( scan ( paste ( path,aBD,".trn", sep="" ) , comment.char="@"  ) )
deseadas<-scan ( paste( path,aBD,".tst", sep="" ) , comment.char="@"  )
bbdd_NoConcurso( aBD, 4 );
