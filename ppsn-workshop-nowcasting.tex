...
\begin{abstract}
Traffic flow measurement methods must keep a balance between being comprehensive, expensive and cumbersome, such as traffic spirals, or being cheap, mobile but missing some counts.
...
to balance accuracy and price or convenience. Spirals embedded in the
...
%FERGU: se va a usar también los datos de espiras para validar? Si es así, indicarlo aquí
