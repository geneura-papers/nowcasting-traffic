...
occupying a street in a particular moment usualy requires finding a balance between accuracy and price or convenience. Spirals, also called
traffic loops, 
\cite{klein2006traffic} are embedded in the
...
\cite{Castillo2014caplibro, DBLP:conf/smartct/Fernandez-AresA16}, which take advantage of the emitting devices in the vehicles, cannot count those without this feature and thus their accuracy is limited; incidentally, systems such
...
a place, which is then compared with the actual one from the more precise spirals. We use standard and bioinspired methods, trying to find
%FERGU: se va a usar también los datos de espiras para validar? Si es
%así, indicarlo aquíç
%hecho - JJ
what is the best option for the volume and type of data
...
%El ejemplo que se pone siempre, es por ejemplo, que durante la noche viajan más "profesionales de la conducción" y menos tráfico "normal"
