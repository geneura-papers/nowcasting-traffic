...
a place, obtained from the more precise spirals, after proving that,
effectively, there is a correlation between both so that prediction
...
BT and WiFi antenna connected via USB and configured in monitor mode (WiFi) and discovering mode (BT)
