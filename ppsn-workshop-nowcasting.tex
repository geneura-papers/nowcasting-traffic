...
the real number of vehicles given that we have the number of vehicles bearing a wireless device. 
% I can not understand the previous sentence. Is it correctly written?   [pedro]
We will use classic and neural network techniques on data gathered in
...
weak has a clear influence on traffic, and it might also have an
...
well as train models and compare then with each other. We have tested
